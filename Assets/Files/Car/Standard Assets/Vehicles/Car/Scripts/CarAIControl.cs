...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        [SerializeField] private Transform m_TargetList;
        [SerializeField] private int m_TargetListLenght = 2;     // 'target' the target object to aim for.
        ...
        public Transform TargetList { get => m_TargetList; set => m_TargetList = value; }
        public int TargetListLenght { get => m_TargetListLenght; set => m_TargetListLenght = value; }
        public bool Driving { get => m_Driving; set => m_Driving = value; }
        ...
        public Transform TargetList1 { get => m_TargetList; set => m_TargetList = value; }
        ...
        public CarAIControl(Transform target, Transform targetList, int targetListLenght, int laps)
        {
            m_Target = target;
            m_TargetList = targetList;
            m_TargetListLenght = targetListLenght;
            this.laps = laps;
        }
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                {
                    if (currentTarget == m_TargetListLenght) { if (laps-1 == currentLap) { m_Driving = false; } else { 
                            currentLap++; currentTarget = 0; } }
                    else 
                    { 
                        m_Driving = true;
                        currentTarget++;
                        m_Target = m_TargetList.transform.GetChild(currentTarget); ;
                    }
