...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField] private long m_MaxHandbrakeTorque;
        ...
        public CarController(float brakeTorque, float topspeed, float downforce, float steerHelper, float tractionControl, float fullTorqueOverAllWheels, float reverseTorque)
        {
            ...
            m_FullTorqueOverAllWheels = fullTorqueOverAllWheels;
        ...
        private void Start()
        {
            ...
            m_MaxHandbrakeTorque = long.MaxValue;
